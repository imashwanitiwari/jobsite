...
<head>
	...
	//Data table CSS 
	echo link_tag('vendors/bower_components/datatables/media/css/jquery.dataTables.min.css');
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ui_dr"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">Channel Companies</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="panels-wells.html">Channel List</a>
						</li>
                        
						<li>
							<a href="<?php echo site_url('admin/add_channel')?>">Add Channel</a>
						</li>
						<li>
							<a href="notifications.html">Deleted Channel</a>
						</li>
						
					</ul>
				</li>
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#form_dr"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Broadcaster</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?php echo site_url('admin/broadcaster_channel');?>">Broadcasters Channel List</a>
						</li>
						
						<li>
							<a href="<?php echo site_url('admin/broadcaster');?>">Add Broadcaster</a>
						</li>
						<li>
							<a href="#">Deleted Broadcaster</a>
						</li>
						
					</ul>
				</li>
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#report"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Company</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="report" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?php echo site_url('admin/company');?>">Add Company</a>
						</li>
						<li>
							<a href="<?php echo site_url('admin/company_service');?>">Company Services</a>
						</li>
						<li>
							<a href="<?php echo site_url('admin/company/company_vc');?>">Company VC</a>
						</li>
						<li>
							<a href="form-mask.html">Company STB</a>
						</li>
						</li>
				...
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#mso"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">MSO</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="mso" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?= base_url('admin/mso/add_mso')?>">Add MSO</a>
						</li>
						<li>
							<a href="<?= base_url('admin/mso/mso_channel')?>">MSO Channels</a>
						</li>
