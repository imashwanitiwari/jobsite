...
<head>
	...
	//Sweetalert CSS 	
	echo link_tag('vendors\bower_components\sweetalert\dist\sweetalert.css');
		
	//Owl Carousel CSS
    echo link_tag('vendors/bower_components/owl.carousel/dist/assets/owl.carousel.min.css');
	
	//Switchery
	echo link_tag('vendors/bower_components/switchery/dist/switchery.min.css');
	
	//Custom CSS 
	echo link_tag('dist/css/style.css');

	// Bootstrap Daterangepicker CSS
	echo link_tag('vendors/bower_components/bootstrap-daterangepicker/daterangepicker.css');
	
	echo link_tag('vendors/bower_components/select2/dist/css/select2.min.css');
	...
	echo link_tag('vendors/bower_components/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css');
	...
	echo link_tag('vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css');
	
	//Data table CSS 
	echo link_tag('css/datatables.min.css');

	// Morris Charts CSS
    echo link_tag('vendors/bower_components/morris.js/morris.css');
	
	// vector map CSS 
	
	echo link_tag('vendors/bower_components/jquery-wizard.js/css/wizard.css');
	
	//jquery-steps css 
	
	echo link_tag('vendors/bower_components/jquery.steps/demo/css/jquery.steps.css');
	
	// bootstrap-touchspin CSS 
		
		echo link_tag('vendors/bower_components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css');
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					...
					<div class="logo-wrap">
						<a href="index-2.html">
							<img class="brand-img" src="<?php echo base_url('images/dcnlogo3.png');?>" alt="brand"/>
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right">
				<ul class="nav navbar-right top-nav pull-right">
					...
					<li class="dropdown auth-drp">
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="<?php echo base_url('images/team_5.png');?>" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ui_dr"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">Cable TV Users</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?php echo site_url('operator/customers');?>">Customers List</a>
						</li>
						<li>
							<a href="modals.html">Customers List[ALL]</a>
						</li>
						<li>
				...
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#form_dr"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Internet Users</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="form_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="form-element.html">Customers List</a>
						</li>
						<li>
							<a href="form-layout.html">Customers List[ALL]</a>
						</li>
						<li>
							<a href="form-advanced.html">Add customer</a>
						</li>
						<li>
							<a href="form-mask.html">Deleted Customers</a>
						</li>
				...
				<li>
					...
					<ul id="report" class="collapse collapse-level-1 two-col-list">
						...
						<li>
							<a href="form-advanced.html">Monetary Analysis</a>
						</li>
						<li>
							<a href="<?php echo site_url('operator/lineman')?>">Lineman Report</a>
						</li>
						<li>
							<a href="form-mask.html">Package Report</a>
						</li>
						<li>
							<a href="form-mask.html">Boxes Report</a>
						</li>
						<li>
							<a href="form-mask.html">Paid/Unpaid Report</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="<?php echo site_url('operator/packages');?>" ><div class="pull-left"><i class="zmdi zmdi-chart-donut mr-20"></i><span class="right-nav-text">Packages </span></div><div class="clearfix"></div></a>
					
				</li>
				<li>
					<a href="<?php echo site_url('operator/products');?>" ><div class="pull-left"><i class="zmdi zmdi-chart-donut mr-20"></i><span class="right-nav-text">Products </span></div><div class="clearfix"></div></a>
					
				</li>
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#taxes"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Taxes</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="taxes" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?php echo site_url('operator/taxes/add_tax');?>">Add TAX</a>
						</li>
						<li>
							<a href="<?php echo site_url('operator/taxes');?>">TAXES</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="<?php echo site_url('operator/add_area');?>" ><div class="pull-left"><i class="zmdi zmdi-chart-donut mr-20"></i><span class="right-nav-text">Areas </span></div><div class="clearfix"></div></a>
					
				</li>
				<li>
					<a  href="javascript:void(0);" data-toggle="collapse" data-target="#staff"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Staff</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="staff" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="<?php echo site_url('operator/addStaff');?>">Add Staff</a>
						</li>
						<li>
				...
				<li>
					<a href="<?php echo site_url('operator/complaints/all_complaints');?>" ><div class="pull-left"><i class="zmdi zmdi-chart-donut mr-20"></i><span class="right-nav-text">Complaints </span></div><div class="clearfix"></div></a>
					
				</li>
				
				<li>
					<a href="<?php echo site_url('operator/boxes');?>" ><div class="pull-left"><i class="zmdi zmdi-chart-donut mr-20"></i><span class="right-nav-text">Boxes </span></div><div class="clearfix"></div></a>
				...
				<li>
					<a class="active" href="javascript:void(0);" data-toggle="collapse" data-target="#pages_dr"><div class="pull-left"><i class="zmdi zmdi-google-pages mr-20"></i><span class="right-nav-text">DCN Events</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
		...
		<button id="setting_panel_btn" class="btn btn-danger" >Add Packs</button>
