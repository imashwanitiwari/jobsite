          ...
          <div class="page-wrapper">
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						...
						<li class="active"><span>Add broadcaster</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Add Broadcaster</h6>
									</div>
									<div class="clearfix"></div>
                                    <?php if($this->session->flashdata('add_broadcaster')):?>
									<div class="alert alert-dismissible alert-success">
									<button type="button" class="close" data-dismiss="alert">&times;</button>
									<strong>Well done!</strong> This Broadcaster Type Has Been Added Successfully.
									</div>
									<?php endif;?>
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<?=form_open('admin/broadcaster/add')?>
														<div class="form-body">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" id="firstName" class="form-control" placeholder="Name" name="NAME" value="<?= set_value('NAME');?>" maxlength="50" required />
